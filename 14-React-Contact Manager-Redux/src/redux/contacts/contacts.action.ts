...
import {IContacts} from "../../modules/contacts/models/IContacts";
import {ContactService} from "../../modules/contacts/services/ContactService";
import {IGroups} from "../../modules/contacts/models/IGroups";

/*
 *  Get All Contacts
*/
export const getAllContactsAction: any = createAsyncThunk('contacts/getAllContactsAction', async (payload: {}, {rejectWithValue}): Promise<IContacts[] | any> => {
    try {
...
export const getAContactAction: any = createAsyncThunk('contacts/getAContactAction', async (payload: {
    contactId: string
}, {rejectWithValue, dispatch}): Promise<IContacts[] | any> => {
    try {
...
export const createContactAction: any = createAsyncThunk('contacts/createContactAction', async (payload: {
    contact: IContacts
}, {rejectWithValue}): Promise<IContacts | any> => {
    try {
...
export const updateContactAction: any = createAsyncThunk('contacts/updateContactAction', async (payload: {
    contact: IContacts, contactId: string
}, {rejectWithValue}): Promise<IContacts | any> => {
    try {
 ...
 *  Get all groups
*/
export const getAllGroupsAction: any = createAsyncThunk('contacts/getAllGroupsAction', async (payload: {}, {rejectWithValue}): Promise<IGroups[] | any> => {
    try {
...
export const getAGroupAction: any = createAsyncThunk('contacts/getAGroupAction', async (payload: {
    contact: IContacts
}, {rejectWithValue}): Promise<IGroups | any> => {
    try {
        const {contact} = payload;
