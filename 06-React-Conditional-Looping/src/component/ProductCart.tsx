...
export const ProductCart: React.FC = () => {
                            ...
                            watches.map((watch, index) => {
                                return (
                                    <tr key={index}>
                                        <td>{watch.id}</td>
                                        <td>
                                            <img src={watch.imageUrl} width={50} height={50} alt="Image not found"/>
                                        </td>
    ...
    return (
        <>
            ...
            {
                watches.length > 0 ? <>{displayTheRecords()}</> : <>{displayEmptyRecord()}</>
            }
